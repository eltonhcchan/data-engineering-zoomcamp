...
- `stg_green_tripdata`, `stg_yellow_tripdata`, and `int_trips_unioned` (upstream dependencies) (Ans)
- Any model with upstream and downstream dependencies to `int_trips_unioned`
- `int_trips_unioned` 
- `int_trips_unioned`, `int_trips`, and `fct_trips` (downstream dependencies)

From the output log, it mentioned below.
13:19:45  1 of 1 START sql view model dev.int_trips_unioned .............................. [RUN]
13:19:45  1 of 1 OK created sql view model dev.int_trips_unioned ......................... [OK in 0.10s]

In addition, it also initialize tables `stg_green_tripdata` and `stg_yellow_tripdata`
As a result, it created `stg_green_tripdata`, `stg_yellow_tripdata`, and `int_trips_unioned` (upstream dependencies) 
---
...
- dbt will fail the test, returning a non-zero exit code (Ans)
- dbt will pass the test with a warning about the new value
- dbt will update the configuration to include the new value

dbt returned the following error when test failed.
      Failed [   2.28s] test      dbt_prod_dbt_test__audit.accepted_values_fct_trips_payment_type__false__2__3__4__5 (test)
...
SELECT sum(revenue_monthly_total_amount) as revenue, pickup_zone FROM `dtc-de-course-482514.dbt_prod.fct_monthly_zone_revenue`  where service_type = 'Green'
...
SELECT sum(total_monthly_trips) as total FROM `dtc-de-course-482514.dbt_prod.fct_monthly_zone_revenue`  where service_type = 'Green'
and 
DATE(revenue_month) BETWEEN '2019-10-01' AND '2020-10-30';
---
